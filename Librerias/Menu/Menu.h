...
public:
 ...
 int id;//Id of this menu
 boolean (*canEnter)(Menu&);//Function to be called when this menu is 'used'

 Menu(String n, int Id);//Constructs the Menu with a name and a NULL use function (be careful calling it)
 Menu(String n,boolean (*c)(Menu&));//Constructs the Menu with a specified use function
 ...
 void SetName(String n); // Change the menu name
 void SetId(int id); // Change the menu id
};
